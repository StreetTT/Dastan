...
class Dastan:
    ...
    def __CreateCustomPlayers(self):
        self._Players[0].SetName(input("What is Player One's Name: "))
        firstAsk = True
        while self._Players[0].GetName() == self._Players[1].GetName() or firstAsk:
            firstAsk = False
            self._Players[1].SetName(input("What is Player Two's Name: "))
            if self._Players[0].GetName() == self._Players[1].GetName():
                print("Pick a diffrent Name")
                self._Players[1].SetName(self._Players[0].GetName())
        print(self._Players[0].GetName() + " vs. " + self._Players[1].GetName())
