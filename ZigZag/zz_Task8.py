         ...
         #  START OF EDIT
            ...
            while not(LockedInMove):
                ...
                while Choice < 1 or Choice > 3:
                    ...
                    if MoveLegal: 
                        PrevScore = self._CurrentPlayer.GetScore() - 5
                        ...
                        self.__DisplayState()
                UndoChoice = input("Would you like to undo this move (Y/N): ")
                if UndoChoice == "N":
                    LockedInMove = True
                    ...
                    self._CurrentPlayer.ChangeScore(-(self._CurrentPlayer.GetScore()) + PrevScore)
...
class MoveOptionQueue:
    ...
    def ResetQueueBack(self, Position):
        Item = self.__Queue.pop(-1)
        self.__Queue.insert(Position, Item)
