...
class Dastan:
    ...
    def __DisplayState(self):
        ...
        print(f"Offers Remaining: {self._CurrentPlayer.GetOffers()}") ## CODE ADDED
        print()
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                ...
                if Choice == 9 and self._CurrentPlayer.GetOffers() > 0: ## CODE EDITED
                    self.__UseMoveOptionOffer()
                    self._CurrentPlayer.SetOffers() ## CODE ADDED
                    self.__DisplayState()
                elif self._CurrentPlayer.GetOffers() <= 0: ## CODE ADDED
                    print("No More Offers Availible") ## CODE ADDED
